...
const SqsPublisherSubscriber_1 = require("./SqsPublisherSubscriber");
describe("SqsPublisherSubscriber", () => {
    ...
    beforeEach(() => {
        ...
        publisherSubscriber = new SqsPublisherSubscriber_1.SqsPublisherSubscriber("us-east-1");
        publisherSubscriber.sqsClient = sqsClientMock;
    });
    afterEach(() => {
        jest.resetAllMocks();
        jest.useRealTimers();
    ...
    describe("publish", () => {
        it("should send a message with the right command and message attributes", async () => {
            ...
            const sentCommand = sqsClientMock.send.mock.calls[0][0];
            expect(sentCommand).toBeInstanceOf(client_sqs_1.SendMessageCommand);
    ...
    describe("subscribe", () => {
        it("should poll messages, parse them and call callback with message and control", async () => {
            ...
            sqsClientMock.send
                ...
                if (command instanceof client_sqs_1.ReceiveMessageCommand) {
            ...
            const subscribePromise = publisherSubscriber.subscribe({ destination: "queue-url", pollInterval: 1000 }, callbackMock);
            ...
            expect(sqsClientMock.send).toHaveBeenCalledWith(expect.any(client_sqs_1.ReceiveMessageCommand));
...
//# sourceMappingURL=SqsPublisherSubscriber.spec.js.map